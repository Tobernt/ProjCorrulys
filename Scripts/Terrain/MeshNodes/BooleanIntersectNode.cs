...
public class BooleanIntersectNode : MeshNode
{
    ...
    public override ProBuilderMesh GenerateMesh(ProBuilderMesh inputMesh)
    {
        ...
        {
            Debug.LogError("❌ BooleanIntersectNode requires at least one input mesh or an assigned prefab!");
            return null;
        }
        ...
        {
            Debug.LogError("❌ BooleanIntersectNode: One or both meshes are null!");
            return null;
        }
        ...
        Model resultModel = CSG.Intersect(objA, objB);

        if (resultModel == null)
        {
            Debug.LogError("❌ Boolean Intersection failed!");
            return null;
        }
    ...
    private ProBuilderMesh ConvertCSGResultToProBuilder(Model csgResult)
    {
        ...
        Debug.Log("✅ Boolean Intersection completed successfully!");
        return resultMesh;
    }
}
